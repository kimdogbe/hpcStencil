...
void init_image(const int nx, const int ny, double * restrict  image, double * restrict  tmp_image);
void output_image(const char * file_name, const int nx, const int ny, double * restrict image);
double wtime(void);
...
void output_image(const char * file_name, const int nx, const int ny, double * restrict restrict image) {
